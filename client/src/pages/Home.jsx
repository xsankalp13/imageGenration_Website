...
const RenderCards = ({data, title}) => {
    ...
    return (
        <h2 className='mt-5 font-bold text-[#6449ff] txt-xl uppercase'>{title}</h2>
    )
}
        ...
        const fetchPosts = async () =>{
            ...
            try{
                ...
                if(response.ok){
                    ...
                    setAllPosts(result.data.revese());
                }
    ...
    <section className='max-w-7xl mx-auto'>
        <div>
            ...
            <p className='mt-2 text-[#666e75] text-[14px] max-w-[500px]'>
                Browse through a collection of imagenative and visually stunnig images generate by DALL-E AI
            </p>
        </div>
        <div className='mt-16'>
